...
const EventDetailsHeader = ({ activeTab } : EventDetailsHeaderProps) => {
  ...
  return (
    <div className="w-full flex items-center justify-between p-2.5">
      ...
      <button className="bg-BG-1 rounded-full w-12 h-12 flex justify-center items-center" onClick={() => navigate(-1)}>
